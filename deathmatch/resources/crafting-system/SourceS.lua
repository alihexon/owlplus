-- Define craftable items (server-side only)
local craftableItems = {
    { id = 1, name = "pcp", displayName = "PCP", itemID = 43, materials = { { id = 33, quantity = 2 }, { id = 34, quantity = 1 } } },       
    { id = 2, name = "redbandana", displayName = "Red Bandana", itemID = 123, materials = { { id = 160, quantity = 1 } } }, 
    { id = 3, name = "cocaine", displayName = "Cocaine", itemID = 50, materials = { { id = 42, quantity = 3 } } },
    { id = 4, name = "cocainee", displayName = "Cocaine Brick", itemID = 51, materials = { { id = 43, quantity = 2 } } },
    { id = 5, name = "meth", displayName = "Meth", itemID = 52, materials = { { id = 44, quantity = 2 }, { id = 42, quantity = 1 } } },
    { id = 6, name = "heroin", displayName = "Heroin", itemID = 53, materials = { { id = 45, quantity = 3 } } },
    { id = 7, name = "heroinn", displayName = "Heroin Brick", itemID = 54, materials = { { id = 46, quantity = 2 }, { id = 44, quantity = 1 } } }
}
...
function craftItem(player, itemID)
    ...
    if foundItem then
        ...
        outputChatBox("Crafting " .. foundItem.displayName .. "... (5 seconds)", player, 0, 255, 0)
...
function onPlayerLeaveMarker(hitPlayer)
    if getElementType(hitPlayer) == "player" then
        ...
        if activeCraftingSessions[hitPlayer] then
            outputChatBox("Crafting canceled. You left.", hitPlayer, 255, 0, 0)
